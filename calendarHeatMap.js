async function drawHeatMap() {
    ...
    try {
        ...
        dataset = await d3.json("https://raw.githubusercontent.com/Dionkaps/test/main/data.json");
        console.log(JSON.stringify(dataset, null, 2)); // Log the loaded data as a JSON string

        // Your code using the 'dataset' goes here
